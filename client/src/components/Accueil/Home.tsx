          ...
          <form className="w-full max-w-sm mx-auto bg-white p-8 rounded-md shadow-md" method="POST" onSubmit={handleSubmit}>
            <div className="mb-4">
              ...
              <input className="w-full px-3 py-2 border border-gray-300 rounded-md mb-3 focus:outline-none focus:border-indigo-500"
                type="text" placeholder="e.g : Backend developer" name="job_title" required>
              </input>
              ...
              <input className="w-full px-3 py-2 border border-gray-300 rounded-md mb-3 focus:outline-none focus:border-indigo-500"
                type="text" placeholder="e.g : Google" name="company" required>
              </input>
              ...
              <input className="w-full px-3 py-2 border border-gray-300 rounded-md mb-3 focus:outline-none focus:border-indigo-500"
                type="number" min={0} placeholder="e.g : 120k$ / year" name="salary" required>
              </input>
              ...
              <input className="w-full px-3 py-2 border border-gray-300 rounded-md mb-3 focus:outline-none focus:border-indigo-500"
                type="text" placeholder="e.g : Technical stack : Javascript..." name="description" required>
              </input>
              ...
              <input className="w-full px-3 py-2 border border-gray-300 rounded-md mb-3 focus:outline-none focus:border-indigo-500"
                type="text" placeholder="e.g : https://m5.apply.indeed.com/..." name="offer">
              </input>
              ...
              <input className="w-full px-3 py-2 border border-gray-300 rounded-md mb-3 focus:outline-none focus:border-indigo-500"
                type="date" name="application_date" required>
              </input>
            </div>
